...
# ng build
# docker build -t dtuncbilek/dt-raider-angular:0.1.0 .
# docker run -d -p 18750:80 --name dt-raider-angular --restart unless-stopped dtuncbilek/dt-raider-angular:0.1.0
